...
router.patch('/resetPassword', handleValidation(resetPasswordValidation), auth(['user', 'admin']), resetPassword)
router.patch('/changePassword', handleValidation(changePasswordValidation), auth(['user', 'admin']), changePassword)
